...
public class BezierCollider2DEditor : Editor
{
    ...
    void OnSceneGUI()
    {
        if (bezierCollider != null)
        {
          ...
          /*  var points3d = bezierCollider.calculate3DPoints();
            lineRenderer.SetVertexCount(points3d.GetLength(1));
            lineRenderer.SetPositions(bezierCollider.calculate3DPoints()); */
